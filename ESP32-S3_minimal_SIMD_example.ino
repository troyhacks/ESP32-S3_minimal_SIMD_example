...
uint16_t __attribute__((aligned (16))) u16_A[] = {26, 225, 38, 21, 42, 217, 140, 102, 213, 15, 196, 94, 47, 176, 165, 233, 84, 211, 115, 241, 129, 207, 117, 52, 255, 48, 244, 149, 44, 10, 134, 96, 80, 23, 206, 119, 4, 164, 242, 154, 203, 158, 142, 79, 249, 118, 19, 82, 130, 128, 192, 5, 201, 222, 200, 83, 24, 191, 41, 66, 111, 193, 220, 147, 194, 236, 37, 181, 125, 182, 124, 252, 122, 180, 169, 74, 59, 174, 20, 146, 30, 95, 110, 13, 178, 32, 195, 152, 11, 27, 145, 224, 9, 229, 109, 148, 251, 72, 153, 136, 86, 199, 92, 55, 239, 25, 1, 114, 104, 230, 198, 131, 246, 168, 76, 159, 101, 113, 250, 187, 135, 71, 34, 179, 6, 57, 18, 184};
uint16_t __attribute__((aligned (16))) u16_B[8] = {64,64,64,64,128,128,128,128};
uint16_t __attribute__((aligned (16))) u16_C[128] = {0};
uint8_t sar = 0;
